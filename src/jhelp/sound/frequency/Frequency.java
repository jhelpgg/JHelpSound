      ...
      extends InputStream
{
   ...
   static
   {
      ...
      {
         (6 << shift) - 1, (7 << shift) - 1, (8 << shift) - 1, (7 << shift) - 1, (7 << shift) - 1, (6 << shift) - 1, (7 << shift) - 1, (8 << shift) - 1,//
         (7 << shift) - 1, (7 << shift) - 1, (5 << shift) - 1, (5 << shift) - 1, (5 << shift) - 1, (5 << shift) - 1, (4 << shift) - 1, (4 << shift) - 1,//
         (4 << shift) - 1, (4 << shift) - 1, (3 << shift) - 1, (3 << shift) - 1, (3 << shift) - 1, (3 << shift) - 1
      };
   ...
   public static void main(final String[] args)
   {
      ...
      try
      {
         ...
         final AudioFormat audioFormat = new AudioFormat(AudioFormat.Encoding.PCM_UNSIGNED, number, 8, 2, 1, number * 16, true);
         ...
         Debug.println(DebugLevel.INFORMATION, clip.getFramePosition(), '/', clip.getFrameLength());
      ...
      {
         Debug.printException(exception, "Issue while try play A 440Hz");
      }
   }
